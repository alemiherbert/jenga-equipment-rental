...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    startAutoplay: function startAutoplay() {
      ...
      this.$refs.container.addEventListener('touchstart', function () {
        return _this2.stopAutoplay();
      });
      this.$refs.container.addEventListener('touchend', function () {
        return _this2.startAutoplay();
      });
    },
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return fetch('/api/featured-equipment');
            case 5:
            ...
            case 10:
              _this3.equipment = _context.sent;
              _this3.$nextTick(function () {
                _this3.updateMaxScroll();
              });
              _context.next = 18;
              break;
            case 14:
              ...
              _this3.error = 'Unable to load featured equipment. Please try again later.';
