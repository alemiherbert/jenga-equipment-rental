...
document.addEventListener('alpine:init', function () {
  Alpine.data('equipmentDetails', function () {
    return {
      ...
      get isValidBooking() {
        return this.booking.startDate && this.booking.endDate && this.booking.distance >= 0 && new Date(this.booking.endDate) >= new Date(this.booking.startDate);
      },
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                _this.error = 'Unable to load equipment details. Please try again later.';
            ...
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                return fetch('/api/bookings', {
                  ...
                  body: JSON.stringify({
                    equipment_id: _this2.equipment.id,
                    start_date: _this2.booking.startDate,
                    end_date: _this2.booking.endDate,
                    distance: _this2.booking.distance,
                    equipment_cost: _this2.equipmentCost,
                    transport_cost: _this2.transportCost,
                    total_amount: _this2.totalCost
                  })
                });
              case 7:
                response = _context2.sent;
              ...
              case 16:
                ...
                _this2.error = _context2.t0.message || 'Failed to create booking. Please try again.';
              case 19:
                _context2.prev = 19;
...
/* harmony import */ var _display_equipment__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_display_equipment__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _carousel__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./carousel */ "./src/js/carousel.js");
/* harmony import */ var _equipment_grid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./equipment-grid */ "./src/js/equipment-grid.js");
...
/* harmony import */ var _alpinejs_focus__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @alpinejs/focus */ "./node_modules/@alpinejs/focus/dist/module.esm.js");
/* harmony import */ var feather_icons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! feather-icons */ "./node_modules/feather-icons/dist/feather.js");
/* harmony import */ var feather_icons__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(feather_icons__WEBPACK_IMPORTED_MODULE_13__);
...
feather_icons__WEBPACK_IMPORTED_MODULE_13___default().replace();
window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_11__["default"];
// window.searchComponent = searchComponent;
alpinejs__WEBPACK_IMPORTED_MODULE_11__["default"].plugin(_alpinejs_focus__WEBPACK_IMPORTED_MODULE_12__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_11__["default"].data('carousel', _carousel__WEBPACK_IMPORTED_MODULE_9__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_11__["default"].data('featuredEquipment', _featured_equipment__WEBPACK_IMPORTED_MODULE_3__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_11__["default"].data('equipmentGrid', _equipment_grid__WEBPACK_IMPORTED_MODULE_10__["default"]);
