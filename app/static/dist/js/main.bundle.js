...
document.addEventListener('alpine:init', function () {
  Alpine.data('cartDisplay', function () {
    return {
      cart: [],
      init: function init() {
      ...
      removeItem: function removeItem(equipmentId) {
...
document.addEventListener('alpine:init', function () {
  Alpine.data('authComponent', function () {
    return {
  ...
  Alpine.data('userComponent', function () {
    return {
      userName: 'Guest',
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 8:
                data = _context2.sent;
                _this3.userName = data.name || 'User';
                _context2.next = 15;
                break;
              case 12:
                _context2.prev = 12;
                _context2.t0 = _context2["catch"](0);
                _this3.userName = 'Guest';
              case 15:
              case "end":
...
document.addEventListener('alpine:init', function () {
  Alpine.data('checkoutForm', function () {
    return {
      cart: [],
      billing: {
        name: '',
      ...
      removeFromCart: function removeFromCart(equipmentId) {
        this.cart = this.cart.filter(function (item) {
          return item.equipment_id !== equipmentId;
        });
        localStorage.setItem('bookingCart', JSON.stringify(this.cart));
...
document.addEventListener('alpine:init', function () {
  Alpine.data('bookingDataTable', function (dataSource, filterParams) {
    return {
      curPage: 1,
      filters: [],
      formData: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                _this.updateResultsCount();
                _this.$nextTick(function () {
                  return feather_icons__WEBPACK_IMPORTED_MODULE_0___default().replace();
                });
                _this.$watch('formData', function () {
                  _this.curPage = 1;
                  _this.fetchData();
                }, {
                  deep: true
                });
                _this.$watch('search', Alpine.debounce(function () {
                  _this.curPage = 1;
                  _this.fetchData();
                }, 300));
              case 6:
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (_this2.formData.status && _this2.formData.status !== 'All') {
                  params.append('status', _this2.formData.status);
                }
                if (_this2.formData.equipment_id) {
                  params.append('equipment_id', _this2.formData.equipment_id);
                }
                if (_this2.formData.start_date) {
                  params.append('start_date', _this2.formData.start_date);
                }
                if (_this2.formData.end_date) {
                  params.append('end_date', _this2.formData.end_date);
                }
                _context2.next = 11;
                return fetch("/api/bookings?".concat(params.toString()));
              case 11:
                response = _context2.sent;
                if (response.ok) {
                  _context2.next = 14;
              ...
              case 16:
                data = _context2.sent;
                _this2.bookings = data.items.map(function (item) {
                  return {
                    id: item.id,
                    start_date: item.start_date,
                    end_date: item.end_date,
                ...
                _this2.total = data._meta.total_items;
                _this2.updateResultsCount();
                _context2.next = 26;
                break;
              case 22:
                _context2.prev = 22;
      ...
      sort: function sort(col) {
        ...
        this.bookings.sort(function (a, b) {
          if (a[_this3.sortCol] < b[_this3.sortCol]) return _this3.sortAsc ? 1 : -1;
          if (a[_this3.sortCol] > b[_this3.sortCol]) return _this3.sortAsc ? -1 : 1;
          return 0;
        });
      },
      updateSelectAllStatus: function updateSelectAllStatus() {
        this.selectAll = this.selectedItems.length === this.bookings.length;
      },
      toggleAllCheckbox: function toggleAllCheckbox() {
        var filteredItems = this.filtered(this.bookings);
      ...
      deselectAllCheckbox: function deselectAllCheckbox() {
      ...
      updateResultsCount: function updateResultsCount() {
        var start = (this.curPage - 1) * this.pageSize + 1;
        var end = Math.min(this.curPage * this.pageSize, this.total);
        this.resultsCount = "Showing ".concat(start, " to ").concat(end, " of ").concat(this.total, " results");
      },
      filtered: function filtered() {
        ...
        var values = items.shift();
        var props = items.length ? items : null;
        return values.filter(function (i) {
          var y = _objectSpread({}, i);
          delete y.userId;
          if (props) {
            var okeys = Object.keys(y).filter(function (b) {
              return !props.includes(b);
            });
            okeys.map(function (d) {
              return delete y[d];
            });
          }
          var itemToSearch = Object.values(y).join();
          return itemToSearch.toLowerCase().includes(_this4.search.toLowerCase());
        });
      },
      ...
      deleteSelectedItems: function deleteSelectedItems() {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
          var _iterator, _step, item, response;
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _iterator = _createForOfIteratorHelper(_this5.selectedItems);
                _context3.prev = 2;
                _iterator.s();
              case 4:
                ...
                item = _step.value;
                _context3.next = 8;
                return fetch("/api/bookings/".concat(item.id), {
                  method: 'DELETE',
                  headers: {
                    'Content-Type': 'application/json',
              ...
              case 8:
                ...
                throw new Error("Failed to delete booking with ID ".concat(item.id));
              case 11:
                _context3.next = 4;
                break;
              case 13:
              ...
              case 25:
                ...
                console.error('Error deleting bookings:', _context3.t1);
                alert('Failed to delete selected bookings');
              case 29:
              case "end":
                return _context3.stop();
            }
          }, _callee3, null, [[0, 25], [2, 15, 18, 21]]);
        }))();
      },
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                if (!confirm("Are you sure you want to delete booking #".concat(item.id, "?"))) {
                  _context4.next = 15;
                  break;
                }
                _context4.prev = 1;
              ...
              case 11:
                ...
                console.error('Error deleting booking:', _context4.t0);
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
          ...
          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                newStatus = prompt('Enter new status (pending/confirmed/cancelled):', item.status);
                if (!(newStatus === null)) {
                  _context5.next = 3;
                  break;
                }
              ...
              case 13:
                ...
                console.error('Error updating booking:', _context5.t0);
      ...
      addNewBooking: function addNewBooking() {
...
document.addEventListener('alpine:init', function () {
  Alpine.data('equipmentDataTable', function (dataSource, filterParams) {
    return {
      curPage: 1,
      filters: [],
      formData: {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                _this.updateResultsCount();
                _this.$nextTick(function () {
                  return feather_icons__WEBPACK_IMPORTED_MODULE_1___default().replace();
                });
                _this.$watch('formData', function () {
                  _this.curPage = 1;
                  _this.fetchData();
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (_this2.formData.location && _this2.formData.location !== 'All') {
                  params.append('location', _this2.formData.location);
                }
                if (_this2.formData.category && _this2.formData.category !== 'All') {
              ...
              case 15:
                ...
                _this2.equipment = _data.items.map(function (item) {
                  return {
                    id: item.id,
                    name: item.name,
                    ...
                    status: item.status,
                    image: item.image ? "/uploads/".concat(item.image) : 'https://picsum.photos/80/80',
                    selected: false
                  };
                });
                _this2.total = _data._meta.total_items;
                _this2.updateResultsCount();
                _context2.next = 25;
                break;
              case 21:
      ...
      toggleAllCheckbox: function toggleAllCheckbox() {
        var filteredItems = this.filtered(this.equipment);
        if (filteredItems.length === this.selectedItems.length) {
          filteredItems.forEach(function (item) {
            return item.selected = false;
          });
          ...
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              ...
              case 8:
                ...
                throw new Error("Failed to delete item with ID ".concat(item.id));
              case 11:
                _context3.next = 4;
                break;
              case 13:
              ...
              case 25:
                _context3.prev = 25;
                _context3.t1 = _context3["catch"](0);
                console.error('Error deleting items:', _context3.t1);
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              ...
              case 11:
                _context4.prev = 11;
                _context4.t0 = _context4["catch"](1);
                console.error('Error deleting item:', _context4.t0);
...
document.addEventListener('alpine:init', function () {
  Alpine.data('paymentDataTable', function (dataSource, filterParams) {
    return {
      curPage: 1,
      filters: [],
      formData: {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (_this2.formData.min_amount) {
                  params.append('min_amount', _this2.formData.min_amount);
                }
                if (_this2.formData.max_amount) {
                  params.append('max_amount', _this2.formData.max_amount);
                }
                if (_this2.formData.start_date) {
                  params.append('start_date', _this2.formData.start_date);
                }
                ...
                _context2.next = 12;
                return fetch("/api/payments?".concat(params.toString()));
              case 12:
                response = _context2.sent;
                if (response.ok) {
                  _context2.next = 15;
              ...
              case 17:
                data = _context2.sent;
                _this2.payments = data.items.map(function (item) {
                  return {
                    id: item.id,
      ...
      toggleAllCheckbox: function toggleAllCheckbox() {
        var filteredItems = this.filtered(this.payments);
        if (filteredItems.length === this.selectedItems.length) {
          filteredItems.forEach(function (item) {
            return item.selected = false;
          });
          ...
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                item = _step.value;
                _context3.next = 8;
                return fetch("/api/payments/".concat(item.id), {
                  method: 'DELETE',
                  headers: {
                    'Content-Type': 'application/json',
                    'Authorization': "Bearer ".concat(localStorage.getItem('token'))
              ...
              case 8:
                ...
                throw new Error("Failed to delete payment with ID ".concat(item.id));
              case 11:
                _context3.next = 4;
                break;
              case 13:
              ...
              case 25:
                _context3.prev = 25;
                _context3.t1 = _context3["catch"](0);
                console.error('Error deleting payments:', _context3.t1);
      ...
      deleteItem: function deleteItem(item) {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                if (!confirm("Are you sure you want to delete payment #".concat(item.id, "?"))) {
                  _context4.next = 15;
                  break;
                }
                _context4.prev = 1;
              ...
              case 11:
                _context4.prev = 11;
                _context4.t0 = _context4["catch"](1);
                console.error('Error deleting payment:', _context4.t0);
      ...
      editItem: function editItem(item) {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
          ...
          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                newStatus = prompt('Enter new status (pending/succeeded/failed/refunded):', item.status);
                if (!(newStatus === null)) {
                  _context5.next = 3;
                  break;
                }
              ...
              case 13:
                _context5.prev = 13;
                _context5.t0 = _context5["catch"](3);
                console.error('Error updating payment:', _context5.t0);
...
document.addEventListener('alpine:init', function () {
  Alpine.data('userDataTable', function (dataSource, filterParams) {
    return {
      curPage: 1,
      filters: [],
      formData: {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (_this2.formData.role && _this2.formData.role !== 'All') {
                  params.append('role', _this2.formData.role);
                }
                _context2.next = 8;
                return fetch("/api/users?".concat(params.toString()));
              case 8:
                response = _context2.sent;
                if (response.ok) {
                  _context2.next = 11;
              ...
              case 13:
                data = _context2.sent;
                _this2.users = data.items.map(function (item) {
                  return {
                    id: item.id,
                    name: item.name,
                    email: item.email,
      ...
      toggleAllCheckbox: function toggleAllCheckbox() {
        var filteredItems = this.filtered(this.users);
        if (filteredItems.length === this.selectedItems.length) {
          filteredItems.forEach(function (item) {
            return item.selected = false;
          });
          ...
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                item = _step.value;
                _context3.next = 8;
                return fetch("/api/users/".concat(item.id), {
                  method: 'DELETE',
                  headers: {
                    'Content-Type': 'application/json',
                    'Authorization': "Bearer ".concat(localStorage.getItem('token'))
              ...
              case 8:
                ...
                throw new Error("Failed to delete user with ID ".concat(item.id));
              case 11:
                _context3.next = 4;
                break;
              case 13:
              ...
              case 25:
                _context3.prev = 25;
                _context3.t1 = _context3["catch"](0);
                console.error('Error deleting users:', _context3.t1);
      ...
      editItem: function editItem(item) {
        var _this7 = this;
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
          var newName, newEmail, newRole, response;
          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                newName = prompt('Enter new name:', item.name);
                newEmail = prompt('Enter new email:', item.email);
                newRole = prompt('Enter new role:', item.role);
...
document.addEventListener('alpine:init', function () {
  Alpine.data('equipmentDetails', function () {
    return {
      equipment: {
        category: '',
        featured: false,
      ...
      get isEquipmentInCart() {
        ...
        return this.cart.some(function (item) {
          return item.equipment_id === _this.equipment.id;
        });
      },
      ...
      get canAddToCart() {
        return this.isValidBooking && !this.isEquipmentInCart && this.isEquipmentAvailable && !this.dateError;
      },
      ...
      get totalDays() {
        ...
        var start = new Date(this.booking.startDate);
        var end = new Date(this.booking.endDate);
        var diff = end - start;
      ...
      get isValidBooking() {
        return this.booking.startDate && this.booking.endDate && this.validateDates();
      },
      formatCurrency: function formatCurrency(amount) {
        return new Intl.NumberFormat('en-UG').format(amount);
      },
      fetchEquipmentDetails: function fetchEquipmentDetails(equipmentId) {
        var _this2 = this;
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var response, data;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return fetch("/api/equipment/".concat(equipmentId));
              case 5:
                response = _context.sent;
                if (response.ok) {
                  _context.next = 8;
              ...
              case 10:
                data = _context.sent;
                _this2.equipment = _objectSpread(_objectSpread({}, data), {}, {
                  image: data.image ? "/uploads/".concat(data.image) : 'https://picsum.photos/600/400'
                });
                _context.next = 18;
                break;
              case 14:
                ...
                _this2.error = 'Unable to load equipment details. Please try again later.';
      ...
      removeFromCart: function removeFromCart() {
        var _this3 = this;
        this.cart = this.cart.filter(function (item) {
          return item.equipment_id !== _this3.equipment.id;
        });
        localStorage.setItem('bookingCart', JSON.stringify(this.cart));
            ...
            case 14:
              ...
              _this2.equipment = data.items.map(function (item) {
                return {
                  ...
                  image: item.image ? "/uploads/".concat(item.image) : 'https://picsum.photos/400/300',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    fetchFeaturedEquipment: function fetchFeaturedEquipment() {
      var _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return fetch('/api/equipment/featured');
            case 5:
              response = _context.sent;
              if (response.ok) {
                _context.next = 8;
            ...
            case 10:
              data = _context.sent;
              _this2.equipment = data.featured_equipment.map(function (item) {
                return {
                  id: item.id,
                  name: item.name,
                  category: item.category,
            ...
            case 14:
              ...
              _context.t0 = _context["catch"](2);
              _this2.error = _context.t0.message;
              console.error('Error fetching featured equipment:', _context.t0);
            case 18:
              _context.prev = 18;
              _this2.loading = false;
              return _context.finish(18);
    ...
    startAutoplay: function startAutoplay() {
      ...
      this.autoplayInterval = setInterval(function () {
        if (!document.hidden) {
          if (_this3.scroll >= _this3.maxScroll) {
            _this3.scroll = 0;
          } else {
            _this3.scrollNext();
          }
...
document.addEventListener('alpine:init', function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('auth', {
    tokens: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              url = args[0], _args$ = args[1], options = _args$ === void 0 ? {} : _args$;
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('userState', function () {
  return {
    userName: 'guest',
    init: function init() {
      if (alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('auth').isAuthenticated()) {
...
document.addEventListener('alpine:init', function () {
  Alpine.data('login', function () {
    return {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                _context.next = _context.t1 === 401 ? 21 : _context.t1 === 400 ? 23 : _context.t1 === 500 ? 25 : 26;
                break;
              case 21:
                _this2.error = 'Invalid email or password';
                return _context.abrupt("break", 27);
              case 23:
                _this2.error = data.msg || 'Missing required fields';
                return _context.abrupt("break", 27);
              case 25:
              ...
              case 37:
                ...
                console.error('Login error:', _context.t2);
      ...
      storeAuthTokens: function storeAuthTokens(tokens) {
...
(function () {
  var initializeRangeGroup = function initializeRangeGroup(rangeGroup) {
    var decrement = rangeGroup.querySelector('[data-action="decrement"]');
    var increment = rangeGroup.querySelector('[data-action="increment"]');
    var label = rangeGroup.querySelector('.form-label__value');
    var suffix = label.getAttribute('data-suffix') || '';
    var control = rangeGroup.querySelector('.range-group__control');
    var step = parseInt(control.getAttribute('step'), 10) || 1;
    var min = parseInt(control.getAttribute('min'), 10) || 0;
    var max = parseInt(control.getAttribute('max'), 10) || 100;
    var checkDisabledState = function checkDisabledState(value) {
      decrement.disabled = min === value;
      increment.disabled = max === value;
    };
    var updateValues = function updateValues(value) {
      control.value = value;
      label.textContent = "".concat(value, " ").concat(suffix);
  ...
  var rangeGroups = document.querySelectorAll('.range-group');
...
// registration.js
document.addEventListener('alpine:init', function () {
  Alpine.data('registration', function () {
    return {
      form: {
        name: '',
        email: '',
      ...
      handleValidationErrors: function handleValidationErrors(data) {
        var _this3 = this;
        // Handle specific field errors from API
        if (data.errors) {
          Object.keys(data.errors).forEach(function (field) {
            _this3.errors[field] = data.errors[field];
          });
        } else {
...
(function (_localStorage$getItem) {
...
/* harmony import */ var _register__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_register__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./login */ "./src/js/login.js");
/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_login__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _check_auth__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./check-auth */ "./src/js/check-auth.js");
...
/* harmony import */ var _display_equipment__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./display-equipment */ "./src/js/display-equipment.js");
/* harmony import */ var _range_group__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./range-group */ "./src/js/range-group.js");
/* harmony import */ var _range_group__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_range_group__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cart */ "./src/js/cart.js");
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./checkout */ "./src/js/checkout.js");
...
/* harmony import */ var _dash_users__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./dash-users */ "./src/js/dash-users.js");
/* harmony import */ var _dash_bookings__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./dash-bookings */ "./src/js/dash-bookings.js");
/* harmony import */ var _dash_payments__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./dash-payments */ "./src/js/dash-payments.js");
/* harmony import */ var _carousel__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./carousel */ "./src/js/carousel.js");
/* harmony import */ var _equipment_grid__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./equipment-grid */ "./src/js/equipment-grid.js");
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
/* harmony import */ var _alpinejs_focus__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @alpinejs/focus */ "./node_modules/@alpinejs/focus/dist/module.esm.js");
/* harmony import */ var feather_icons__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! feather-icons */ "./node_modules/feather-icons/dist/feather.js");
/* harmony import */ var feather_icons__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(feather_icons__WEBPACK_IMPORTED_MODULE_22__);
...
feather_icons__WEBPACK_IMPORTED_MODULE_22___default().replace();
window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"];
// window.searchComponent = searchComponent;
alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"].plugin(_alpinejs_focus__WEBPACK_IMPORTED_MODULE_21__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"].data('carousel', _carousel__WEBPACK_IMPORTED_MODULE_18__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"].data('featuredEquipment', _featured_equipment__WEBPACK_IMPORTED_MODULE_3__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"].data('equipmentGrid', _equipment_grid__WEBPACK_IMPORTED_MODULE_19__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_20__["default"].start();
})();
